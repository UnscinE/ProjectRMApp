...
class TrainingRepo {
  ...
  static Future<void> setTargetKm(String uid, int i) async {}

  static Future<void> setTrainingWeeks(String uid, int i) async {}
}
...
class ProgramRepo {
  ...
  static Future<QueryDocumentSnapshot<Map<String, dynamic>>?> fetchLatestActive(String userId) async {
